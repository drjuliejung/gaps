function save_rms_chunks_for_each_file2(num_files, name_prefix, name_suffix, first_rms_split, second_rms_split, max_val)
...
for i=1:num_files
    ...
    [heavy1_90s, heavy2_90s] = separate_chunks_into_rms_ranges2(field, first_rms_split, second_rms_split, max_val);
