function save_rms_chunks_for_each_file(num_files, name_prefix, name_suffix, first_rms_split, second_rms_split, max_val)
...
for i=1:num_files
    ...
    [light_90s, medium_90s, heavy_90s] = separate_chunks_into_rms_ranges(field, first_rms_split, second_rms_split, max_val);
