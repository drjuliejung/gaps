...
subplot(4,1,1)       % add 1st plot in 7 x 1 grid (stim C)
...
% 
% subplot(7,1,3)       % add 3rd plot in 7 x 1 grid (stim G, real time)
...
% 
% subplot(7,1,4)       % add 4th plot in 7 x 1 grid (stim H, real time)
...
subplot(4,1,2)       % add 5th plot in 7 x 1 grid (stim D, no gap)
...
subplot(4,1,3)       % add 6th plot in 7 x 1 grid (stim G, no gap)
...
subplot(4,1,4)       % add 7th plot in 7 x 1 grid (stim H, no gap)
